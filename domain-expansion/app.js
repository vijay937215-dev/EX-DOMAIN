...
if (typeof window.supabase !== 'undefined' && SUPABASE_URL !== 'YOUR_SUPABASE_URL_HERE') {
    ...
    console.warn('⚠️ Supabase URL or Anon Key not configured yet. Set SUPABASE_URL and SUPABASE_ANON_KEY at top of app.js.');
}


document.addEventListener('DOMContentLoaded', () => {
    
    // Update Telemetry Status if Supabase configured
    ...
    if (sbStatusEl) {
        if (supabase) {
            ...
            sbStatusEl.textContent = 'KEYS NEEDED';
    ...
    // ==================== 10. REGISTRATION FORM VALIDATION & SUPABASE INTEGRATION ====================
